			...
			<div class="col-md-offset-2 col-md-4">
				<div class="panel" style="width: 200%;">
					<div class="panel-heading text-white" align="center"
						...
						<h2>
							<span style="color: gray;">MyWeb</span> 회원 정보 수정
						</h2>
					</div>
					<div class="panel-body">
						<form action="/MyWeb/update.user" method="post"
							...
							<table
								...
								<tr>
									<td style="width: 100%; text-align: center; colspan: 2;">
										...
										onclick="return confirm('수정하시겠습니까?')"> &nbsp;&nbsp; <input
										type="button" value="취소" class="btn btn-danger btn-lg"
										onclick="location.href='/MyWeb'">
									</td>
								</tr>
