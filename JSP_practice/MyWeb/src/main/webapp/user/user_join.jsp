			...
			<div class="col-md-offset-2 col-md-4">
				<div class="panel" style="width: 200%;">
					<div class="panel-heading text-white" align="center"
						...
						<h2>
							<span style="color: gray;">MyWeb</span> 회원 가입
						</h2>
					</div>
					<div class="panel-body">
						<form action="/MyWeb/join.user" method="post" name="reg_form"
							...
							<table
								...
								<tr>
									<td><input type="password" size="17" name="pw"
								...
								<tr>
									<td style="text-align: left">
										<p>
											<strong>비밀번호를 재확인 해 주세요.</strong>&nbsp;&nbsp;&nbsp;
										</p>
									</td>
								</tr>
								<tr>
									<td><input type="password" size="17" name="pw_check"
										class="form-control" maxlength="20"
										style="ime-mode: inactive; margin-bottom: 25px; height: 40px; border: 1px solid #d9d9de"
								...
								<tr>
									<td style="width: 100%; text-align: center; colspan: 2;">
										<input type="button" value="회원가입" class="btn form-control"
										onclick="joinConfirm()"
