...
public class ResponseController {
	  ...
	  @GetMapping("/res-ex01") public void resEx01() {}
	 /* 
	...
	@PostMapping("/login")
	public String login(String userId, String userPw, @RequestParam("userPwChk") String pwChk, RedirectAttributes ra) {
