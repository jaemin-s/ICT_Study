				...
				<tr>
					<td colspan="5" align="center">
						<ul class="pagination pagination-lg">
							...
							<%-- 이전 버튼 --%>
							<c:if test="${pc.prev}">
								<li class="page-item"><a class="page-link" href="/MyWeb/list.board?page=${pc.beginPage-1}&cpp=${pc.paging.cpp}"
							...
							<li class="page-item"><a href="/MyWeb/list.board?page=${pageNum}&cpp=${pc.paging.cpp}" class="page-link"
								style="margin-top: 0; height: 40px; color: pink; border: 1px solid #643691; ${pageNum==pc.paging.page?'background-color:#dbff79':''}">${pageNum}</a>
							</li>
							</c:forEach>

							<%-- 다음 버튼 --%>
							<c:if test="${pc.next}">
								<li class="page-item"><a class="page-link" href="/MyWeb/list.board?page=${pc.endPage+1}&cpp=${pc.paging.cpp}"
