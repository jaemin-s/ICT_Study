...
<body>
	...
	<div align="center" style="margin-bottom: 20px; padding-bottom: 50px;">
		...
		<form action="/MyWeb/changePw.user" method="post">
			...
			<input type="password" name="old_pw" required="required"> <br>
			<br>
			<p>
				<strong>변경 비밀번호</strong>
			</p>
			<input type="password" name="new_pw" required="required"> <br>
			<br> <input type="submit" value="확인"
				class="btn btn-primary btn-lg"> &nbsp;&nbsp; <input
				type="button" value="취소" class="btn btn-default btn-lg"
