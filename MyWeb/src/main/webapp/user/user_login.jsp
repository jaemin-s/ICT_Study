			...
			<div class="col-md-offset-2 col-md-4">
				<div class="panel" style="width: 200%;">
					<div class="panel-heading text-white" align="center"
						...
						<h2>
							<span style="color: gray;">MyWeb</span> 로그인
						</h2>
					</div>
					<div class="panel-body">
						<form action="/MyWeb/login.user" method="post"
							...
							<table
								...
								<tr>
									<td><input type="password" name="pw" size="17"
										maxlength="20" class="form-control" required="required"
										aria-required="true"
								...
								<tr>
									<td style="padding-top: 10px; text-align: center">
										<p>
											<strong>로그인하셔서 더 많은 서비스를 이용해보세요!</strong>
										</p>
									</td>
								</tr>
								<tr>
								...
								<tr>
									<td
										...
										<a class="btn form-control" href="/MyWeb/login.user">
